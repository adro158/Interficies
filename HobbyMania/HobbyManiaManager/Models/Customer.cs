...
namespace HobbyManiaManager.Models
{
    public class Customer : ICloneable
    {
        ...
        public Customer(int id, string name, string email, string phoneNumber, DateTime registrationDate)
        {
            Id = id;
            Name = name;
            Email = email;
        ...
        public object Clone()
        {
            return new Customer(Id, Name, Email, PhoneNumber, RegistrationDate)
            {
